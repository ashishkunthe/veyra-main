        ...
        <div className="p-6">
          ...
          {step === 2 && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                <label className="text-xs font-semibold text-gray-700">Logo URL (optional)</label>
                <input
              ...
              <div>
                <label className="text-xs font-semibold text-gray-700">Tax Information (optional)</label>
                <input
                  value={companyData.taxInfo}
                  onChange={(e) => setCompanyData({ ...companyData, taxInfo: e.target.value })}
